...
<template>
  <Navbar/>
  <div>
    <div class="" :style="{ marginLeft: navbarActive ? '16.5rem' : '0' }" style="margin-top: 3.5rem; background-color: rgba(21, 20, 23, 0.95); height: 92vh;">
          ...
          <div id="daftar" class="" style="">
            <div class="card shadow-lg" style="border: none; border-radius: 1rem; background-color: rgba(255, 255, 255, 0.05);">
              <div class="card-body py-4 px-4">
                <label class="" style="color: rgba(255, 255, 255, 0.5); font-size: 0.95rem;">Saat ini login Sebagai</label>
                <div class="d-sm-grid d-md-flex justify-content-between mt-3">
                  <div class="d-flex gap-3 mb-2">
                    <img width="40" src="@/assets/img/logo.svg">
                    <div class="d-grid">
                      <label class="" style="font-size: 0.9rem;">21. Muhammad Daffa</label>
                      <label class="text-secondary" style="font-size: 0.8rem;">daffa11futn@gmail.com</label>
                    </div>
                  </div>
                  <div class="d-flex">
                    <button class="btn btn-outline-success fw-bold btn-sm px-4 border-secondary">Ganti Akun</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div id="daftar" class="" style="">
            <div class="card shadow-lg" style="border: none; border-radius: 1rem; background-color: rgba(255, 255, 255, 0.05);">
              <div class="card-body form-control-sm py-4 px-4">
                <div class="d-grid">
                  <label class="" style="color: rgba(255, 255, 255, 1); font-size: 0.95rem;">Course Code</label>
                  <label class="" style="color: rgba(255, 255, 255, 0.5); font-size: 0.85rem;">Mintalah kode kursus kepada pengajar, lalu masukan kode disini</label>
                </div>
